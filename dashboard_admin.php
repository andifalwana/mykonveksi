        ...
        <div class="card-body">
            <form method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tcons" value="<?= $vcons ?>" class="form-control"
                ...
                <div class="col-md-6 mx-auto">
                    <form method="POST">
                        <div class="input-group mb-3">
                            ...
                            <a href="pdf.php" target="_blank" class="btn btn-success">
                                <i class="fa fa-file-pdf-o"></i>&nbsp PRINT
                            </a>
                ...
                <table class="table table-info table-hover table-bordered">
                    ...
                    while ($data = mysqli_fetch_array($tampil)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="dashboard_admin.php?hal=edit&id=<?= $data['id_pesanan'] ?>" class="btn btn-warning">Edit</a>

                                <a href="dashboard_admin.php?hal=hapus&id=<?= $data['id_pesanan'] ?>" class="btn btn-danger"
                                    onclick="return confirm('Apakah Anda Yakin Ingin Mengapus Data Tersebut?')">Hapus</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
